    ...
    <div class="container-fluid">
        <div class="row" style="background-color:black ;">
            ...
            <div class="row">
               ...
               ?>
                   <b> <p>Welcome,Please Sign In</p></b>
              <div class="col adminform">
             
                <form method="post" action="process/signin_process.php" id="adf">
                    <input type="email" name="email" placeholder="Email Address" class="form-control my-5" required>
                    <input type="password" name="password" placeholder="Password" class="form-control">
                    <a href="#" id="pass">Forgot password?</a>
                    <span id="signa">New here?<a href="signup.php" id="sig" required>Sign up</a> </span>
                </br>
